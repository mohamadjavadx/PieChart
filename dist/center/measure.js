 ...
 */
export function canvasTextMeasurer(fontFamily) {
    const context = document.createElement("canvas").getContext("2d");
    if (!context)
        throw new Error("A canvas is needed to measure text");
 ...
 */
export function approximateTextMeasurer(characterWidth = 0.56) {
